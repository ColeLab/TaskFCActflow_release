...
def _load_parcellated_timeseries(subj, run, parcelCIFTIFile_directory, rawdata_directory):
    ...
    L_parcelCIFTIFile=parcelCIFTIFile_directory+'SeparateHemispheres/Q1-Q6_RelatedValidation210.L.CorticalAreas_dil_Final_Final_Areas_Group.32k_fs_LR.dlabel.nii'
    R_parcelCIFTIFile=parcelCIFTIFile_directory+'SeparateHemispheres/Q1-Q6_RelatedValidation210.R.CorticalAreas_dil_Final_Final_Areas_Group.32k_fs_LR.dlabel.nii'
