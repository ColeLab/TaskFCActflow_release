...
datadir = '/projects/f_mc1689_1/HCP352Data/data/'
...
nuis_reg_dir = datadir + 'hcppreprocessedmsmall/nuisanceRegressors/'
...
outputdir = '/projects/f_mc1689_1/TaskFCActflow/data/hcppreprocessedmsmall/parcellated_postproc/'
#
...
def step2_nuisanceRegression(subj_nums=subjNums,nproc=5, model='24pXaCompCorXVolterra',spikeReg=False,zscore=False):
    """
...
def _nuisanceRegression(subj, run, inputdata, outputdir,  model='24pXaCompCorXVolterra', spikeReg=False, zscore=False, nproc=8):
    ...
    outputfilename = outputdir + subj + '_glmOutput2_data.h5'
